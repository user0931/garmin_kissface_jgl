...
module Time {
	...
	function drawText(dc, cx, cy) {
      ...
      //drawDigit(dc, 20, cy-text_height_digit/2-10, text, activePercent, Gfx.COLOR_ORANGE);
        drawDigit(dc, 28, cy-text_height_digit/2-12, text, activePercent, Gfx.COLOR_ORANGE);
      ...
      //drawDigit(dc, 13+text_width_digit, cy-text_height_digit/2-10, text, floorsPercent, Gfx.COLOR_BLUE);
        drawDigit(dc, 24+text_width_digit, cy-text_height_digit/2-12, text, floorsPercent, Gfx.COLOR_BLUE);
		...
		drawDigit(dc, 40+text_width_digit*2, cy-text_height_digit/2-12, text, stepsPercent, Gfx.COLOR_RED);
        ...
        drawDigit(dc, 34+text_width_digit*3, cy-text_height_digit/2-12, text, caloriesPercent, Gfx.COLOR_GREEN);
	}
    ...
    function drawDigit(dc, x, y, text, value, color) {
        ...
        dc.fillRectangle(x, y, text_width_digit, text_height_digit-5);
      ...
      /*  if (diff > 10) {
        ...
        //dc.drawText(x, y*2+21, font, text, Gfx.TEXT_JUSTIFY_VCENTER | Gfx.TEXT_JUSTIFY_LEFT);
        dc.drawText(x, y*2+23, font, text, Gfx.TEXT_JUSTIFY_VCENTER | Gfx.TEXT_JUSTIFY_LEFT);
